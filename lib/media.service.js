...
export default class extends Parent {
    ...
    create(data, params, headers) {
        return super.post(`/media`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    update(mediaId, data, params, headers) {
        super.requiredInput('$wpApiMedia:update', {
            mediaId
        });
        return super.post(`/media/${mediaId}`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    delete(mediaId, data, params, headers) {
        super.requiredInput('$wpApiMedia:delete', {
            mediaId
        });
        return super.delete(`/media/${mediaId}`, data, params, headers);
    }
}
