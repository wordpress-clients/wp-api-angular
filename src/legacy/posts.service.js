...
export default class extends Parent {
    ...
    create(data, params, headers) {
        return super.post(`/posts`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    update(postId, data, params, headers) {
        super.requiredInput('$wpApiPosts:update', {
            postId
        });
        return super.post(`/posts/${postId}`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    delete(postId, data, params, headers) {
        super.requiredInput('$wpApiPosts:delete', {
            postId
        });
        return super.delete(`/posts/${postId}`, data, params, headers);
    }
