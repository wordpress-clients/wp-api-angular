...
export default class extends Parent {
    ...
    create(data, params, headers) {
        return super.post(`/pages`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    update(pageId, data, params, headers) {
        super.requiredInput('$wpApiPages:update', {
            pageId
        });
        return super.post(`/pages/${pageId}`, params, data, headers);
    }
     ...
     * @returns {Object} Promise
     */
    delete(pageId, data, params, headers) {
        super.requiredInput('$wpApiPages:delete', {
            pageId
        });
        return super.delete(`/pages/${pageId}`, data, params, headers);
    }
